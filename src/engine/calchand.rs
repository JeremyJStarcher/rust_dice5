...
#[cfg(test)]
mod tests {
    use super::super::get_new_scorecard_data;
    use super::super::LineId as L;
    use super::*;
    ...
    fn test_ace_all_aces() {
        ...
        let score = (scorecard.get_scoreable_by_id(L::Ace).calc)(&hand, false);
        assert_eq!(score, 1 * 5);
    }
    ...
    fn test_two_all_twos() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Two).calc)(&hand, false);
        assert_eq!(score, 2 * 5);
    }
    ...
    fn test_three_all_threes() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Three).calc)(&hand, false);
        assert_eq!(score, 3 * 5);
    }
    ...
    fn test_four_all_fours() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Four).calc)(&hand, false);
        assert_eq!(score, 4 * 5);
    }
    ...
    fn test_fives_all_fives() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Five).calc)(&hand, false);
        assert_eq!(score, 5 * 5);
    }
    ...
    fn test_six_all_sixes() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Six).calc)(&hand, false);
        assert_eq!(score, 6 * 5);
    }
    ...
    fn test_4k_four_sixes() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::FourKind).calc)(&hand, false);
    ...
    fn test_small_straight_low_straight() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::SmallStraight).calc)(&hand, false);
    ...
    fn test_small_straight_dice5_special() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::SmallStraight).calc)(&hand, true);
        assert_eq!(score, VALUE_SMALL_STRAIGHT);
    }
    ...
    fn test_large_straight_high_straight() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::LargeStraight).calc)(&hand, false);
    ...
    fn test_large_straight_dice5_special() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::LargeStraight).calc)(&hand, true);
        assert_eq!(score, VALUE_LARGE_STRAIGHT);
    }
    ...
    fn test_full_house_no_full_house() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::FullHouse).calc)(&hand, false);
        assert_eq!(score, 0);
    }
    ...
    fn test_full_house_dice5_special() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::FullHouse).calc)(&hand, true);
        assert_eq!(score, VALUE_FULL_HOUSE);
    }
    ...
    fn test_chance() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Chance).calc)(&hand, false);
    ...
    fn test_dice5_has_dice5() {
        ...
        let scorecard = get_new_scorecard_data();
        let score = (scorecard.get_scoreable_by_id(L::Dice5).calc)(&hand, false);
